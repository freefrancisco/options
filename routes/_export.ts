...
`]})})]})}function x(s={}){let{wrapper:e}=Object.assign({},p(),s.components);return e?n(e,Object.assign({},s,{children:n(m,s)})):m(s)}var _=x;var O={"/_404":y,"/_app":k,"/":A,"/docs":v,"/docs/get-started":t,"/docs/index":l,depGraph:{"modules":[{"specifier":"./routes/docs/get-started.mdx"},{"specifier":"./routes/docs/index.mdx"}]}};export{O as default};
